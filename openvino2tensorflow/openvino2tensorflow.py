...
def convert(model,
    ...
    for idx, layer in enumerate(layers):
        ...
        ### HardSigmoid
            ...
            tf_layers_dict[layer_id] = hard_sigmoid(tf_layers_dict[tf_edges[layer_id][0]])
        ...
        ### SoftPlus
            ...
            tf_layers_dict[layer_id] = softplus(tf_layers_dict[tf_edges[layer_id][0]])
        ...
        ### Range - TODO
            ...
            tf_layers_dict[layer_id] = tf.range(tf_layers_dict[tf_edges[layer_id][0]][0],
                                                ...
                                                delta=int(tf_layers_dict[tf_edges[layer_id][2]]),
                                                dtype=dtype)
        ...
        ### Equal
            ...
            tf_layers_dict[layer_id] = tf.math.equal(tf_layers_dict[tf_edges[layer_id][0]], tf_layers_dict[tf_edges[layer_id][1]])
